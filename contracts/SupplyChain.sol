...
contract SupplyChain {
  ...
  function buyItem(uint _sku) public payable forSale(items[_sku].state, items[_sku].price) checkValue(_sku) paidEnough(items[_sku].price)
  {
